						...
						<ul class="nav nav-tabs card-header-tabs">
							...
							<li class="nav-item dropdown"><a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">내 활동</a>
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item active" href="/member/myQuiz">만든 퀴즈</a></li>
					...
					<div class="card-body">
						<div class="card m-0">
							<div class="card-body col-12 mx-auto">
								<h4 class="card-title text-center">내가 만든 퀴즈</h4>
								<hr>
                                        ...
                                        <c:choose>
                                            <c:when test="${ pageMaker.totalCount gt 0 }">
		                                        <c:forEach var="myQuiz" items="${ myQuiz }">
			                                        <tr onclick="location.href='/quiz/content?bunchNum=${ myQuiz.num }'">
			                                            <td><c:out value="${myQuiz.num}" /></td>
			                                            <td><c:out value="${myQuiz.title}" /></td>
