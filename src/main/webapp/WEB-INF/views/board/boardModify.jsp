...
<body>
	...
	<%---------- Main ----------%>
	<main class="m-0">
		<form action="/board/modify" method="POST" id="formBoard" name="formBoard" enctype="multipart/form-data">
						...
						<div class="card">
							<div class="text-dark mx-auto mt-4" style="width: 98%">
								...
								<div class="mx-auto my-3" style="width: 98%">
									...
									<div class="col-12">
										<input class="form-control span12" type="text" id="subject" name="subject" value="${ board.subject }" required />
									</div>
                                    ...
                                    <!-- 기존 첨부파일 -->
                                    <div class="row" id="oldFiles">
                                        <c:forEach var="attach" items="${ attachList }">
                                            <div class="oldFile">
                                                <input class="input-oldfile" type="hidden" name="oldFile" value="${ attach.uuid }">
                                                <div class="attach-name mt-2">
                                                    <span>${ attach.filename }</span>
                                                    <button class="delete-oldFile btn btn-dark"><i class="fas fa-times"></i></button>
                                                </div>
                                            </div>
                                        </c:forEach>
                                    </div>
	...
	<script>
	   var fileCount = 1;
		...
		// 기존 첨부파일 삭제 버튼 누를 시
		$('.delete-oldFile').on('click',function(){
		    $(this).parents('.oldFile').children('.input-oldfile').prop('name','delFile');
